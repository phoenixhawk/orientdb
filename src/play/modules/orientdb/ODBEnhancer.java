    ...
    public void enhanceThisClass(ApplicationClass applicationClass) throws Exception {
        ...
        if (ctClass.subtypeOf(classPool.get(Model.class.getName()))) {
            ...
            CtMethod all = CtMethod
                    .make(String
                            .format("public static com.orientechnologies.orient.core.iterator.OObjectIteratorCluster all() { return db().browseClass(play.Play.classloader.getClassIgnoreCase(\"%s\")); }",
                                    entityName), ctClass);
